...
import 'package:flutter_http_request_own/state_management.dart';
        ...
        Center(
          child: Wrap(
            ...
            children: [
              ...
              ElevatedButton(
                onPressed: stateManager.makePostRequestOwn,
                child: Text('POST own'),
              ),
              ElevatedButton(
                onPressed: stateManager.makePostRequestOwnLibsodium,
                child: Text('POST Libsodium'),
              ),
              ElevatedButton(
